...
-- --------------------------------------------------
-- Date Created: 11/11/2023 14:59:49
-- Generated from EDMX file: D:\CSharp_Training_all_day\Test\MVC_TEST\MVC_TEST_1\MVC_TEST_1\Models\Model1.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[NorthwindModelStoreContainer].[ProductsPrice]', 'U') IS NOT NULL
    DROP TABLE [NorthwindModelStoreContainer].[ProductsPrice];
GO
...
-- Creating primary key on [ProductName] in table 'ProductsPrices'
ALTER TABLE [dbo].[ProductsPrices]
ADD CONSTRAINT [PK_ProductsPrices]
